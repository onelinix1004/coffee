...
public class OrderItemController {
     ...
     * @return a ResponseEntity containing the created OrderItemDTO,
    ...
    /**
     * Deletes an order item by its ID from the repository.
     *
     ...
     *         or a 404 response if the order item with the given ID is not found
     */
